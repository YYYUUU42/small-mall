package com.yu.mall.common.lock.anno;

import com.yu.mall.common.lock.enums.LockStrategy;
import com.yu.mall.common.lock.enums.LockType;
...
public @interface Lock {
    ...
    /**
     * 如果设定了false,则方法结束不释放锁，而是等待 leaseTime 后自动释放
     */
